...
Function Start-Install
{
    ...
    if ($spYear -ne 2022) {
        ...
        Set-ShortcutRunAsAdmin -shortcutFile "$env:ProgramData\Microsoft\Windows\Start Menu\Programs\Microsoft SharePoint Preview Products\SharePoint Preview Management Shell.lnk"
    }
}
#endregion
